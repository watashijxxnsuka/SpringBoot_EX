...
public class BoardDto {
    ...
    public FreeBoard toFreeBoardEntity(Member member) {
        return FreeBoard.builder()
                .id(this.id).title(this.title).content(this.content).member(member).cnt(this.cnt)
                .regdate(this.regdate).moddate(this.moddate).boardFileList(new ArrayList<>())
                .build();
    }
    ...
    public Notice toNoticeEntity(Member member) {
        return Notice.builder()
                .id(this.id).title(this.title).content(this.content).member(member).cnt(this.cnt)
                .regdate(this.regdate).moddate(this.moddate).noticeFileList(new ArrayList<>())
                .build();
    }
}
